...
from Application.trading.trading_workflow import start_live_trading_flow, TRADING_APPROACH_CONFIG # noqa: E402
...
async def run():
    ...
    start_live_trading_flow(TRADING_APPROACH_CONFIG)
